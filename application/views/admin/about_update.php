			...
			<div class="row">
			    <div class="col-md-12">
			        <div class="overview-wrap">
			            <h3 class="title-1"><i class="fas fa-sm fa-edit"></i> Update Pengaturan About</h3>
			            <?= anchor('admin/pengaturan/about/','<button class="btn btn-danger">
				...
				<div class="col-lg-12 mt-3">
                    <div class="card">
                        <div class="card-header">
                            <strong>Update Pengaturan About</strong>
