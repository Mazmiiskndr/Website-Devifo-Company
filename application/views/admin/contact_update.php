			...
			<div class="row">
			    <div class="col-md-12">
			        <div class="overview-wrap">
			            <h3 class="title-1"><i class="fas fa-sm fa-edit"></i> Update Contact</h3>
			            <?= anchor('admin/contact/','<button class="btn btn-danger">
				...
				<div class="col-lg-12 mt-3">
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                        	...
                        	<form action="<?= base_url('admin/contact/update_contact_aksi') ?>" class="form-group" method="post">
                                <div>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="subject" name="subject" class="form-control" value="<?= $row->subject ?>">
