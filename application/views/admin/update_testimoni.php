			...
			<div class="row">
			    <div class="col-md-12">
			        <div class="overview-wrap">
			            <h3 class="title-1"><i class="fas fa-sm fa-edit"></i> Update Testimonials</h3>
				...
				<div class="col-lg-12 mt-3">
                    <div class="card">
                        <div class="card-header">
                            <strong>Update Testimonials</strong>

                        </div>
                        <div class="card-body card-block">
                        	<?php foreach($testimoni as $row) { ?>
                        	<form action="<?= base_url('admin/testimoni/update_testimoni_aksi') ?>" class="form-group" method="post" enctype="multipart/form-data">
                                <div>
