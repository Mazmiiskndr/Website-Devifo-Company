			...
			<div class="row">
			    <div class="col-md-12">
			        <div class="overview-wrap">
			            <h3 class="title-1"><i class="fas fa-sm fa-edit"></i> Update Pengaturan Services</h3>
			            <?= anchor('admin/pengaturan/services/','<button class="btn btn-danger">
				...
				<div class="col-lg-12 mt-3">
                    <div class="card">
                        <div class="card-header">
                            <strong>Update Pengaturan Services</strong>

                        </div>
                        <div class="card-body card-block">
                        	<?php foreach($services as $row) { ?>
                        	<form action="<?= base_url('admin/pengaturan/update_about_aksi') ?>" class="form-group" method="post">
                                <div>
