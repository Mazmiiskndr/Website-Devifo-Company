			...
			<div class="row">
			    <div class="col-md-12">
			        <div class="overview-wrap">
			            <h3 class="title-1"><i class="fas fa-sm fa-plus"></i> Tambah Kategori Produk</h3>
				...
				<div class="col-lg-12 mt-3">
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                        	<form action="<?= base_url('admin/kategori/tambah_kategori_aksi') ?>" class="form-group" method="post">
                                <div>
